            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="https://www.facebook.com/mauricio.nina.73" target="_blank">Mauriinf</a></li>
                  <li class="divider"></li>
      ...
      <footer class="footer">
        <div class="container-fluid">
          <nav class="pull-left">
            <ul>
              <li>
                <a href="https://www.facebook.com/mauricio.nina.73" target="_blank">
                  Mauriinf
                </a>
              </li>
        <!--
          ...
          <p class="copyright pull-right">
            <a href="https://www.facebook.com/mauricio.nina.73" target="_blank">Mauriinf</a> &copy; 2019 
          </p>
        </div>
      </footer>
    </div>
